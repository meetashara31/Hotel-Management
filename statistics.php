 ...
 <script type="text/javascript">
  ...
  <script type="text/javascript">
   ...
   function drawChart() {
       ...
       dataTable.addRows([
          [ new Date(2022, 0, 13), 6   ],
          [ new Date(2022, 0, 14), 7   ],
          [ new Date(2022, 0, 15), 2   ],
          [ new Date(2022, 0, 16), 3   ],
          [ new Date(2022, 0, 17), 3   ],
           //
          [ new Date(2022, 1, 13), 5   ],
          [ new Date(2022, 1, 14), 9 ],
          [ new Date(2022, 1, 15), 5 ],
          [ new Date(2022, 1, 16), 6 ],
          [ new Date(2022, 1, 17), 2 ],
          // Many rows omitted for brevity.
          [ new Date(2022, 2, 4), 3 ],
          [ new Date(2022, 2, 5), 5],
          [ new Date(2022, 2, 12), 6],
          [ new Date(2022, 2, 13), 7],
